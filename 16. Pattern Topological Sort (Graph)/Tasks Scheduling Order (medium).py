...
before it can be scheduled. Given the number of tasks and a list of prerequisite pairs, write a method to find the ordering
...
# my code1 (leetcode has course instead of tasks/ and parent/child node is inversed compare
# to above problem statement that's why my code and answer is little different)
