...
class Solution:
    ...
    def cycle_length(self, slow:ListNode):
        curr = slow
        cycle_length = 0
        while True:
            curr = curr.next
    ...
    def detectCycle(self, head: ListNode) -> ListNode:
        ...
        while fast != None and fast.next != None:
            ...
            if slow == fast: #found cycle
                ...
                #This while loop will never exit because of cycle in LL. Therefore, once we find cycle length it is wise to break this.
                break
        if cycle_length == 0:
            return None
